...
let staff = [
    { name: 'Les', description: `Titolare del banco dei pegni piu famoso al mondo, padre di un figlio che poteva morire, e ti venderà una cosa in questa vita o nell altra`, url: 'Media/les-profile.png' },
    { name: 'Seth', description: ` Seth Gold è il figlio di Les e lavora al banco dei pegni insieme al padre. Seth è spesso coinvolto in competizioni con sua sorella Ashley e cerca di dimostrare il suo valore come gestore del negozio. Ha un carattere forte e a volte conflittuale, ma è anche molto determinato e ambizioso.`, url: 'Media/seth-profile.png' },
    ...
    { name: 'Rick', description: `Rick è un dipendente importante del negozio, spesso coinvolto nelle operazioni quotidiane e nelle interazioni con i clienti. È noto per il suo atteggiamento calmo e professionale, che contrasta con i conflitti interni della famiglia Gold.`, url: 'Media/rick-profile.png' },
